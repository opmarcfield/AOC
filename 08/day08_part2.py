...
def calculate_lcm_cycles(nodes, instructions):
    ...
    # Calculate the LCM of the first cycle steps
    lcm_value = cycles[0][0]
    for cycle in cycles[1:]:
        lcm_value = lcm(lcm_value, cycle[0])
...
steps = calculate_lcm_cycles(nodes, instructions)
print(f"Steps required to reach all nodes ending with Z: {steps}")
